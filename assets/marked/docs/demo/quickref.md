...
Let's link to a few sites.  First, let's use the bare URL, like <//www.github.com>.  Great for text, but ugly for HTML.
Next is an inline link to [Google](//www.google.com).  A little nicer.
...
This is the [inline link](//www.bing.com "Bing") with a "Bing" title.
You can also go to [W3C] [2] and maybe visit a [friend].

[2]: //w3c.org (The W3C puts out specs for web-based things)
[Friend]: //facebook.com/ "Facebook!"
...
![Google Logo](//www.google.com/images/errors/logo_sm.gif) and ![Happy].

[Happy]: //www.wpclipart.com/smiley/simple_smiley/smiley_face_simple_green_small.png ("Smiley face")
